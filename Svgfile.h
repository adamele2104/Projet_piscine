...
{
    public:
        Svgfile(std::string _filename = "output.svg", int _width=1500, int _height=1200);
        ~Svgfile();
        void addPolygon(double x1, double y1, double x2, double y2, double x3, double y3,double x4, double y4, double x5,
                        double y5, double x6, double y6,std::string colorFill);
